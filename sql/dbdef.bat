...
rem Creating tables
set TABLES=settings.sql interface_logs.sql
...
set TABLES=%TABLES% TB_STOWAGE.sql TB_STOWAGE_BOX.sql TB_LOCPOS.sql TB_BLOCK.sql TB_DIST.sql
...
set TABLES=%TABLES% TB_DIST_BLOCK.sql TB_DIST_BLOCK_COURSE_SEQ.sql TB_LARGE_GROUP.sql TB_SUB_TOKUISAKI.sql TB_SUB_TOKUISAKI_CHILD.sql
set TABLES=%TABLES% TB_REPORT.sql TB_PC.sql
set TABLES=%TABLES% actionLogs.sql
