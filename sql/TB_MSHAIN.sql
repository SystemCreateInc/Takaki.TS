...
create table TB_MSHAIN (
	CD_SHAIN						char			(7)			not null,	/* 	社員コード						*/
	...
	CD_BUMON						char            (6)			not null,	/* 	部門コード						*/
	FG_TAISHOKUSHA					char            (1)			not null,	/* 	退職者コード					*/
	ST_KOYO							char            (2)			not null,	/* 	雇用区分						*/
	IF_USER_MAIL_ADDRESS			nvarchar        (128)		not null,	/* 	ユーザーメールアドレス			*/
	CD_YAKUSHOKU					char            (2)			not null,	/* 	役職コード						*/
	CD_SOTO_YAKUSHOKU				char            (2)			not null,	/* 	相当役職						*/
	CD_SHOKUMU						char            (3)			not null,	/* 	職務コード						*/
	CD_SHOZOKU_KAISHA				char            (2)			not null,	/* 	所属会社コード					*/
	CD_SHOZOKU_KANPANI				char            (6)			not null,	/* 	所属カンパニーコード			*/
