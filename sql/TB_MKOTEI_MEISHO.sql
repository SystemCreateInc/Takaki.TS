...
create table TB_MKOTEI_MEISHO (
	...
	CD_MEISHO_SHIKIBETSU			nchar			(5)			not null,	/* 	名称識別						*/
	...
	CD_KYU_MEISHO_SHIKIBETSU		nchar           (5)			not null,	/* 	旧名称識別						*/
	CD_KYU_MEISHO					nchar           (8)			not null,	/* 	旧名称コード					*/
	CD_EX_1							nchar           (10)		not null,	/* 	拡張コード１					*/
	CD_EX_2							nchar           (10)		not null,	/* 	拡張コード２					*/
	CD_EX_3							nchar           (10)		not null,	/* 	拡張コード３					*/
	CD_EX_4							nchar           (10)		not null,	/* 	拡張コード４					*/
	CD_EX_5							nchar           (10)		not null,	/* 	拡張コード５					*/
	FG_EX_1							nchar           (1)			not null,	/* 	拡張フラグ１					*/
	FG_EX_2							nchar           (1)			not null,	/* 	拡張フラグ２					*/
	FG_EX_3							nchar           (1)			not null,	/* 	拡張フラグ３					*/
	FG_EX_4							nchar           (1)			not null,	/* 	拡張フラグ４					*/
	FG_EX_5							nchar           (1)			not null,	/* 	拡張フラグ５					*/
