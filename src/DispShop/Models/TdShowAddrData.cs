...
namespace DispShop.Models
{
    public class TdShowAddrData : TdAddrData
    {
        ...
        public string PickingErrStatusName
        {
        ...
        {
            PickingErrStatusName = "";

            switch (text)
            {
                case "TIM":
                    // PickingErrStatusName = EnumExtensions.GetDescription(TdDisplayUnitStatus.Error);
                    PickingErrStatusName = "異常";
                    break;
                case "NAK":
                    // PickingErrStatusName = EnumExtensions.GetDescription(TdDisplayUnitStatus.Nak);
                    PickingErrStatusName = "異常";
                    break;
                case "OFF":
                    PickingErrStatusName = EnumExtensions.GetDescription(TdDisplayUnitStatus.Off);
                    break;
                case "MID":
                    PickingErrStatusName = EnumExtensions.GetDescription(TdDisplayUnitStatus.Mid);
                    break;
                case "LOW":
                    PickingErrStatusName = EnumExtensions.GetDescription(TdDisplayUnitStatus.Low);
                    break;
                default:
                    break;
            }

            return PickingErrStatusName == "" ? false : true;
        }
    }
