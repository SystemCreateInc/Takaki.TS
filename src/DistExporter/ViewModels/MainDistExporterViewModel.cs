...
using DistExpoter.Infranstructures;
...
{
    public class MainDistExporterViewModel : BindableBase, INavigationAware
    {
        ...
        private ObservableCollection<GroupDist>  _items = new();
        public ObservableCollection<GroupDist> Items
        {
            get => _items;
        ...
        public MainDistExporterViewModel(IDialogService dialogService)
        {
        ...
        private void Send()
        {
            ...
            service.AddProcessor(new DistResultProcessor(new DistResultRepository(keys)));
